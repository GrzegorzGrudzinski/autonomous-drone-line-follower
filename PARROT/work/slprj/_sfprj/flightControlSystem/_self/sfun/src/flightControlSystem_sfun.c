  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "sWFlgouwxZB2SxTz2TaVFHB") == 0) {
     ...
     case 6:
      {
        if (strcmp(instanceChksum, "sfHitHLY1GV1KhJcZaLAzaE") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "sWFlgouwxZB2SxTz2TaVFHB") == 0) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "sfHitHLY1GV1KhJcZaLAzaE") == 0) {
